...
import { ArrowLeft, Shield, FileText, Cookie, Scale, Mail } from 'lucide-react'
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>Process your earnings and withdrawals</li>
                        <li>Send notifications about your account and earnings</li>
            ...
            <Card>
                ...
                <CardContent className="space-y-4 text-sm">
                    <p className="text-muted-foreground">We work with third-party partners to provide our services:</p>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                            <li>Lootably, Torox - for offerwall services</li>
                            <li>CPX Research, Pollfish - for survey opportunities</li>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">4. Data Retention</CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">6. Children's Privacy</CardTitle>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
                    <p>KojoMoney is not intended for children under 18. We do not knowingly collect personal information from children. If we learn we have collected information from a child under 18, we will delete it immediately.</p>
                </CardContent>
            </Card>
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                    <p>By downloading, accessing, or using KojoMoney, you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use our services.</p>
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">3. Account Responsibilities</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">4. Earning Points</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p className="mt-2">Points have no cash value until redeemed. We reserve the right to adjust point values at any time.</p>
                </CardContent>
            </Card>

            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">5. Withdrawals</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Minimum withdrawal: ₦5,000 (or equivalent)</li>
            ...
            <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>VPN or proxy usage to bypass restrictions</li>
                        <li>Manipulating referral system</li>
            ...
            <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                    <p>KojoMoney is provided "as is" without warranties. We are not liable for any indirect, incidental, or consequential damages. Our maximum liability is limited to the amount you have earned and not yet withdrawn.</p>
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">10. Termination</CardTitle>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                    <p>Cookies are small text files stored on your device when you use our app or website. They help us provide a better experience by remembering your preferences and tracking usage patterns.</p>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-4 text-sm">
                    <div>
                        ...
                        <p className="text-muted-foreground">Required for the app to function. These include authentication cookies and security tokens.</p>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-2">Analytics Cookies</h4>
                        <p className="text-muted-foreground">Help us understand how users interact with our app. We use Firebase Analytics and similar tools.</p>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-2">Advertising Cookies</h4>
                        <p className="text-muted-foreground">Used by our advertising partners (AdMob, Meta, etc.) to serve personalized ads and measure ad effectiveness.</p>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-2">Third-Party Cookies</h4>
                        <p className="text-muted-foreground">Set by our partners (survey providers, offerwalls) when you interact with their content.</p>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                    <p>You can manage cookie preferences through your device settings. Note that disabling certain cookies may affect app functionality. For mobile apps, you can reset your advertising identifier in device settings.</p>
                </CardContent>
            </Card>
        ...
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                    ...
                    <p className="mt-2">We will respond within 30 days. You may be asked to verify your identity.</p>
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-lg">Data Transfers</CardTitle>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
                    <p>Your data may be transferred to and processed in countries outside your location, including the United States. We ensure appropriate safeguards are in place, including Standard Contractual Clauses where required.</p>
                </CardContent>
            </Card>
