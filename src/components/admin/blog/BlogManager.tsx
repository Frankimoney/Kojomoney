...
export default function BlogManager({ adminToken }: BlogManagerProps) {
    ...
    return (
        <Card className="w-full border shadow-sm bg-white/50 dark:bg-slate-950/50 backdrop-blur-xl overflow-hidden">
            <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b px-4 sm:px-6 py-4">
                <div>
                    <CardTitle className="text-lg sm:text-xl font-bold bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">
                        Content
                    </CardTitle>
                    <p className="text-xs sm:text-sm text-muted-foreground mt-1">Manage blog posts and settings</p>
                </div>
                <Button size="sm" onClick={handleCreate} className="gap-2 bg-indigo-600 hover:bg-indigo-700 text-white shadow-md shadow-indigo-200 dark:shadow-none">
                    <Plus className="h-4 w-4" /> New
                </Button>
            </CardHeader>
            <CardContent className="p-0">
                <Tabs defaultValue="all" onValueChange={setFilterStatus} className="w-full">
                    <div className="px-4 sm:px-6 py-3 border-b bg-slate-50/50 dark:bg-slate-900/50 overflow-x-auto">
                        <TabsList className="bg-white dark:bg-slate-800 border p-1 h-auto inline-flex min-w-max">
                            <TabsTrigger value="all" className="data-[state=active]:bg-indigo-50 data-[state=active]:text-indigo-600 px-3 py-1.5 h-auto text-xs">All</TabsTrigger>
                            <TabsTrigger value="published" className="data-[state=active]:bg-green-50 data-[state=active]:text-green-600 px-3 py-1.5 h-auto text-xs">Live</TabsTrigger>
                            <TabsTrigger value="draft" className="data-[state=active]:bg-gray-100 px-3 py-1.5 h-auto text-xs">Drafts</TabsTrigger>
                            <TabsTrigger value="pending_review" className="data-[state=active]:bg-amber-50 data-[state=active]:text-amber-600 px-3 py-1.5 h-auto text-xs">Review</TabsTrigger>
                            <TabsTrigger value="blocks" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600 px-3 py-1.5 h-auto text-xs">Blocks</TabsTrigger>
                            <TabsTrigger value="settings" className="data-[state=active]:bg-slate-100 px-3 py-1.5 h-auto text-xs">Settings</TabsTrigger>
                        </TabsList>
                    </div>
