            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-8 xl:gap-10">
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex gap-3">
                        {/* Telegram */}
                        <a href="https://t.me/kojomoney36" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Telegram" className="p-2.5 bg-white/10 hover:bg-[#0088cc]/80 rounded-lg transition-colors group">
                            <Send className="h-5 w-5 text-white group-hover:scale-110 transition-transform" aria-hidden="true" />
                        </a>
                        {/* TikTok */}
                        <a href="https://www.tiktok.com/@kojomoney36" target="_blank" rel="noopener noreferrer" aria-label="Follow us on TikTok" className="p-2.5 bg-white/10 hover:bg-black/60 rounded-lg transition-colors group">
                            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-white group-hover:scale-110 transition-transform" aria-hidden="true">
