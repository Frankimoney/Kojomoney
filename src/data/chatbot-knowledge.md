# KojoBot Knowledge Base
# Last Updated: 2024-01-02
# 
# HOW TO UPDATE: Simply edit this file when the app changes.
# The AI chatbot will automatically use the latest information.
# 
# FORMAT: Use markdown headings and bullet points.
# The bot reads this entire file as its knowledge source.
...
- Contest resets every Sunday at midnight

### Milestones
- 5 referrals: 500 bonus points
- 10 referrals: 1000 bonus points
- 25 referrals: 3000 bonus points
- 50 referrals: 7500 bonus points
...
- Do at least the trivia - it's quick
...
- All activities give double points during Happy Hour
...
- Don't uninstall apps before points credit
...
1. Build your streak - after 7 days you get 20% bonus
...
3. Maintain a 30+ day streak for 50% bonus
...
- Check the app during Happy Hours
...
- Don't uninstall apps too early - wait for points
